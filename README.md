# gChat
A simple global chat plugin for Velocity, based on [lucko/gChat](https://github.com/lucko/gChat) and [N3FS/gChat](https://github.com/N3FS/gChat).

* **Downloads** - <https://github.com/TimyStream/gchat-maven/releases>
...
Clone the repository, ensure you have a recent JDK (11 or newer) installed, then run `mvn package`.